...
class HyperParams(BaseModel):
    ...
    negative_prompt: str = "(<bad_features>)0.60, (poorly drawn face)++, (elderly)++++, old, (disgusting)+++, (scary)+, (distored)+, (disfigured)++, (deformed)+, twisted, (grainy)+, unfocused, eyes closed, (bad smile)++++, (ugly)++++"
